...
class EditorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create editor" do
    assert_difference('Editor.count') do
      post editors_url, params: { editor: { description: @editor.description, title: @editor.title } }
    end
  ...
  test "should update editor" do
    patch editor_url(@editor), params: { editor: { description: @editor.description, title: @editor.title } }
