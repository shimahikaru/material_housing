class Brand < ApplicationRecord
  ...
  enum location: {
    "キッチン":1, 食洗機:2, ラバトリー:3, バス:4, トイレ:5, 玄関収納:6, リビング収納:7, "収納(その他)":8, フローリング:9, タタミ:10, カーペット:11, クッションフロア:12, 玄関床:13, クロス:14, "壁(タイル)":15, "壁(その他)":16, ペット向け:17, タイル:18, 扉:19, 照明:20, カーテン:21
  }
